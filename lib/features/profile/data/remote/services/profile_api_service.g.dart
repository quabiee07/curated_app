...
class _ProfileApiService implements ProfileApiService {
  ...
  Future<ProfileDto> updateUser({
    ...
    required List<MultipartFile> profileImage,
  }) async {
    ...
    _data.files.addAll(profileImage.map((i) => MapEntry('profile_image', i)));
  ...
  @override
  Future<ProfileDto> getUserProfile({required String token}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
